# Contributing to Digipolitan fastlane-heroku
...
* **Did the problem start happening recently** (e.g. after updating to a new version of fastlane-heroku) or was this always a problem?
* If the problem started happening recently, **can you reproduce the problem in an older version of fastlane-heroku ?** What's the most recent version in which the problem doesn't happen? You can download older versions of fastlane-heroku from [the releases page](https://github.com/digipolitan/fastlane-heroku/releases).
* **Can you reliably reproduce the issue?** If not, provide details about how often the problem happens and under which conditions it normally happens.

Include details about your configuration and environment:

* **Which version of fastlane-heroku are you using?
...
#### Template For Submitting Bug Reports
    ...
    **fastlane-heroku version:** [Enter fastlane-heroku version here]
    ...
    * Problem started happening recently, didn't happen in an older version of fastlane-heroku: [Yes/No]
